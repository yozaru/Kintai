...
goal=`mysql -uroot -pMalmen1203 Shukei_development -e "select check_at from timestores where idm = '$card' and check_at between '2015-04-05 05:00:00' and '2015-04-06 04:59:00' order by check_at DESC limit 1"`
